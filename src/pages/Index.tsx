  ...
  return (
    <>
        ...
        <div className="d-flex flex-column p-5 align-items-center"> 
          ...
          <p>Thanks to <a href="https://devchallenges.io/" target={"_blank"}>devchallenges.io</a> to host these challenges.</p>
          <h4 className="m-5" >You can find repository to project <a href="https://github.com/bipin-codes/front-end-challenges" target={"_blank"}>Front end challenges</a></h4>
        </div>
